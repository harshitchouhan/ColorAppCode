            ...
            <CSSTransition key={location.key} classNames="page" timeout={500}>
              <Switch location={location}>
                ...
                <Route
                  ...
                  render={(routeProps) => (
                    <Page>
                      <SingleColorPalette colorId={routeProps.match.params.colorId} palette={generatePalettes(this.findPalette(routeProps.match.params.paletteId))} />
                    </Page>
                  )}
                />
                <Route
                ...
                <Route
                  ...
                  render={(routeProps) => (
                    <Page>
                      <Palette palette={generatePalettes(this.findPalette(routeProps.match.params.id))} />
                    </Page>
                  )}
                />
                <Route
